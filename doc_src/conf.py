...
version = geocamPycroCom.get_version()
# The full version, including alpha/beta/rc tags.
release = geocamPycroCom.get_version()
...
htmlhelp_basename = 'geocamPycroComdoc'
...
latex_documents = [
  ('index', 'app.tex', u'geocamPycroCom Documentation',
   u'Trey Smith', 'manual'),
]
